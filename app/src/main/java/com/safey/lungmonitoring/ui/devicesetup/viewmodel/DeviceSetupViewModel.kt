package com.safey.lungmonitoring.ui.devicesetup.viewmodel
...
@HiltViewModel
class DeviceSetupViewModel @Inject constructor(private val patientRepository: PatientRepository) : ViewModel() {
